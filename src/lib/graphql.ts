...
export function useGetRoomsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<G_GetRoomsQuery, G_GetRoomsQueryVariables>
) {
  const options =
...
export function useGetRoomSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<G_GetRoomQuery, G_GetRoomQueryVariables>
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
...
`;
export type G_CreateOrGetRoomMutationFn = Apollo.MutationFunction<
...
export type CreateOrGetRoomMutationResult =
  Apollo.MutationResult<G_CreateOrGetRoomMutation>;
export type CreateOrGetRoomMutationOptions = Apollo.BaseMutationOptions<
  G_CreateOrGetRoomMutation,
  G_CreateOrGetRoomMutationVariables
>;
...
`;
export type G_SendMessageMutationFn = Apollo.MutationFunction<
...
export type SendMessageMutationResult =
  Apollo.MutationResult<G_SendMessageMutation>;
...
`;
export type G_CreateInternMutationFn = Apollo.MutationFunction<
...
>;
export type CreateInternMutationResult =
  Apollo.MutationResult<G_CreateInternMutation>;
export type CreateInternMutationOptions = Apollo.BaseMutationOptions<
  G_CreateInternMutation,
  G_CreateInternMutationVariables
>;
