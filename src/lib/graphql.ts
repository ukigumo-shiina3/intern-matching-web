...
import type { QueryHookOptions, LazyQueryHookOptions, SuspenseQueryHookOptions, MutationHookOptions, QueryResult, MutationResult, MutationFunction, BaseMutationOptions, SkipToken } from '@apollo/client';
const skipToken = Apollo.skipToken as SkipToken;
 ...
 * });
 */
export function useGetRoomsQuery(baseOptions?: QueryHookOptions<G_GetRoomsQuery, G_GetRoomsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<G_GetRoomsQuery, G_GetRoomsQueryVariables>(GetRoomsDocument, options);
      }
export function useGetRoomsLazyQuery(baseOptions?: LazyQueryHookOptions<G_GetRoomsQuery, G_GetRoomsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<G_GetRoomsQuery, G_GetRoomsQueryVariables>(GetRoomsDocument, options);
        }
export function useGetRoomsSuspenseQuery(baseOptions?: SkipToken | SuspenseQueryHookOptions<G_GetRoomsQuery, G_GetRoomsQueryVariables>) {
...
export type GetRoomsQueryResult = QueryResult<G_GetRoomsQuery, G_GetRoomsQueryVariables>;
 ...
 * });
 */
export function useGetRoomQuery(baseOptions: QueryHookOptions<G_GetRoomQuery, G_GetRoomQueryVariables> & ({ variables: G_GetRoomQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<G_GetRoomQuery, G_GetRoomQueryVariables>(GetRoomDocument, options);
      }
export function useGetRoomLazyQuery(baseOptions?: LazyQueryHookOptions<G_GetRoomQuery, G_GetRoomQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<G_GetRoomQuery, G_GetRoomQueryVariables>(GetRoomDocument, options);
        }
export function useGetRoomSuspenseQuery(baseOptions?: SkipToken | SuspenseQueryHookOptions<G_GetRoomQuery, G_GetRoomQueryVariables>) {
          const options = baseOptions === skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
...
export type GetRoomQueryResult = QueryResult<G_GetRoomQuery, G_GetRoomQueryVariables>;
 ...
 * });
 */
export function useGetMessagesQuery(baseOptions: QueryHookOptions<G_GetMessagesQuery, G_GetMessagesQueryVariables> & ({ variables: G_GetMessagesQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<G_GetMessagesQuery, G_GetMessagesQueryVariables>(GetMessagesDocument, options);
      }
export function useGetMessagesLazyQuery(baseOptions?: LazyQueryHookOptions<G_GetMessagesQuery, G_GetMessagesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<G_GetMessagesQuery, G_GetMessagesQueryVariables>(GetMessagesDocument, options);
        }
export function useGetMessagesSuspenseQuery(baseOptions?: SkipToken | SuspenseQueryHookOptions<G_GetMessagesQuery, G_GetMessagesQueryVariables>) {
          const options = baseOptions === skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
...
export type GetMessagesQueryResult = QueryResult<G_GetMessagesQuery, G_GetMessagesQueryVariables>;
export const CreateOrGetRoomDocument = gql`
  ...
  createOrGetRoom(input: $input) {
    ...
    `;
export type G_CreateOrGetRoomMutationFn = MutationFunction<G_CreateOrGetRoomMutation, G_CreateOrGetRoomMutationVariables>;
 ...
 * });
 */
export function useCreateOrGetRoomMutation(baseOptions?: MutationHookOptions<G_CreateOrGetRoomMutation, G_CreateOrGetRoomMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
...
export type CreateOrGetRoomMutationResult = MutationResult<G_CreateOrGetRoomMutation>;
export type CreateOrGetRoomMutationOptions = BaseMutationOptions<G_CreateOrGetRoomMutation, G_CreateOrGetRoomMutationVariables>;
export const SendMessageDocument = gql`
  ...
  sendMessage(input: $input) {
    ...
    `;
export type G_SendMessageMutationFn = MutationFunction<G_SendMessageMutation, G_SendMessageMutationVariables>;
 ...
 * });
 */
export function useSendMessageMutation(baseOptions?: MutationHookOptions<G_SendMessageMutation, G_SendMessageMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
...
export type SendMessageMutationResult = MutationResult<G_SendMessageMutation>;
export type SendMessageMutationOptions = BaseMutationOptions<G_SendMessageMutation, G_SendMessageMutationVariables>;
export const CreateInternDocument = gql`
  ...
  createIntern(input: $input) {
    ...
    `;
export type G_CreateInternMutationFn = MutationFunction<G_CreateInternMutation, G_CreateInternMutationVariables>;
 ...
 * });
 */
export function useCreateInternMutation(baseOptions?: MutationHookOptions<G_CreateInternMutation, G_CreateInternMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
...
export type CreateInternMutationResult = MutationResult<G_CreateInternMutation>;
export type CreateInternMutationOptions = BaseMutationOptions<G_CreateInternMutation, G_CreateInternMutationVariables>;