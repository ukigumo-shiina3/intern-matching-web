...
export type G_GetInternQuery = { intern?: { id: string, firebaseUid: string, name: string, email: string, schoolName: string, majorName: string, fieldOfStudyId: string, schoolYearId: string, createdAt: string, updatedAt: string } };
