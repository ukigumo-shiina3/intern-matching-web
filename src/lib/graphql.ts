...
export type G_QueryCompanyJobsArgs = {
  companyId: Scalars['ID']['input'];
};
...
export type G_CreateCompanyMutation = { createCompany?: { company: { id: string, firebaseUid: string, name: string, email: string, addressLine: string, prefecture: { id: string, name: string }, municipality: { id: string, name: string } } } };
...
export type G_CreateEntryMutation = { createEntry?: { entry: { id: string, internId: string, jobId: string, currentStatus: string, createdAt: string, updatedAt: string } } };
...
export type G_CreateInternMutation = { createIntern?: { intern: { id: string, firebaseUid: string, name: string, email: string, schoolName: string, majorName: string, fieldOfStudy: { id: string, name: string }, schoolYear: { id: string, name: string } } } };
...
export type G_CreateJobMutation = { createJob?: { job: { id: string, companyId: string, title: string, internConditions: string, isPublished: boolean, createdAt: string, updatedAt: string } } };
...
export type G_UpdateJobMutation = { updateJob?: { job: { id: string, companyId: string, title: string, internConditions: string, isPublished: boolean, createdAt: string, updatedAt: string } } };

export type G_GetCompanyJobsQueryVariables = Exact<{
  companyId: Scalars['ID']['input'];
}>;


export type G_GetCompanyJobsQuery = { companyJobs: Array<{ id: string, companyId: string, title: string, internConditions: string, isPublished: boolean, createdAt: string, updatedAt: string, company: { id: string, name: string, addressLine: string, prefecture: { id: string, name: string }, municipality: { id: string, name: string } } }> };

export type G_GetPublishedJobsQueryVariables = Exact<{ [key: string]: never; }>;


export type G_GetPublishedJobsQuery = { publishedJobs: Array<{ id: string, companyId: string, title: string, internConditions: string, isPublished: boolean, createdAt: string, updatedAt: string, company: { id: string, name: string, addressLine: string, prefecture: { id: string, name: string }, municipality: { id: string, name: string } } }> };
...
export type G_CreateOrGetRoomMutation = { createOrGetRoom?: { room: { id: string, createdAt: string, updatedAt: string, intern: { id: string, name: string }, company: { id: string, name: string } } } };
...
export type G_SendMessageMutation = { sendMessage?: { message: { id: string, content: string, createdAt: string, sender:
        | { id: string, name: string }
        | { id: string, name: string }
       } } };
 ...
 * });
 */
export function useGetCompanyJobsQuery(baseOptions: Apollo.QueryHookOptions<G_GetCompanyJobsQuery, G_GetCompanyJobsQueryVariables> & ({ variables: G_GetCompanyJobsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<G_GetCompanyJobsQuery, G_GetCompanyJobsQueryVariables>(GetCompanyJobsDocument, options);
      }
export function useGetCompanyJobsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<G_GetCompanyJobsQuery, G_GetCompanyJobsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<G_GetCompanyJobsQuery, G_GetCompanyJobsQueryVariables>(GetCompanyJobsDocument, options);
        }
export function useGetCompanyJobsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<G_GetCompanyJobsQuery, G_GetCompanyJobsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<G_GetCompanyJobsQuery, G_GetCompanyJobsQueryVariables>(GetCompanyJobsDocument, options);
        }
...
export type GetCompanyJobsSuspenseQueryHookResult = ReturnType<typeof useGetCompanyJobsSuspenseQuery>;
export type GetCompanyJobsQueryResult = Apollo.QueryResult<G_GetCompanyJobsQuery, G_GetCompanyJobsQueryVariables>;
export const GetPublishedJobsDocument = gql`
...
/**
 * __useGetPublishedJobsQuery__
 *
 * To run a query within a React component, call `useGetPublishedJobsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPublishedJobsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetPublishedJobsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetPublishedJobsQuery(baseOptions?: Apollo.QueryHookOptions<G_GetPublishedJobsQuery, G_GetPublishedJobsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<G_GetPublishedJobsQuery, G_GetPublishedJobsQueryVariables>(GetPublishedJobsDocument, options);
      }
export function useGetPublishedJobsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<G_GetPublishedJobsQuery, G_GetPublishedJobsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<G_GetPublishedJobsQuery, G_GetPublishedJobsQueryVariables>(GetPublishedJobsDocument, options);
        }
export function useGetPublishedJobsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<G_GetPublishedJobsQuery, G_GetPublishedJobsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<G_GetPublishedJobsQuery, G_GetPublishedJobsQueryVariables>(GetPublishedJobsDocument, options);
        }
export type GetPublishedJobsQueryHookResult = ReturnType<typeof useGetPublishedJobsQuery>;
export type GetPublishedJobsLazyQueryHookResult = ReturnType<typeof useGetPublishedJobsLazyQuery>;
export type GetPublishedJobsSuspenseQueryHookResult = ReturnType<typeof useGetPublishedJobsSuspenseQuery>;
export type GetPublishedJobsQueryResult = Apollo.QueryResult<G_GetPublishedJobsQuery, G_GetPublishedJobsQueryVariables>;
