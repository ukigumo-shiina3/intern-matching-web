...
export type G_GetMessagesQuery = {
  messages: Array<{
    id: string;
    content: string;
    createdAt: any;
...
export type G_CreateOrGetRoomMutation = {
  createOrGetRoom?: {
    errors: Array<string>;
    room: {
      id: string;
...
export type G_SendMessageMutation = {
  sendMessage?: {
    errors: Array<string>;
    message?: {
      id: string;
...
export type G_CreateInternMutation = {
  createIntern?: {
    errors: Array<string>;
    intern?: {
      id: string;
...
export function useGetRoomsQuery(
  baseOptions?: QueryHookOptions<G_GetRoomsQuery, G_GetRoomsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<G_GetRoomsQuery, G_GetRoomsQueryVariables>(
    GetRoomsDocument,
    options
  );
}
export function useGetRoomsLazyQuery(
  baseOptions?: LazyQueryHookOptions<G_GetRoomsQuery, G_GetRoomsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<G_GetRoomsQuery, G_GetRoomsQueryVariables>(
    GetRoomsDocument,
    options
  );
}
export function useGetRoomsSuspenseQuery(
  baseOptions?:
    | SkipToken
    | SuspenseQueryHookOptions<G_GetRoomsQuery, G_GetRoomsQueryVariables>
) {
  const options =
    baseOptions === skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<G_GetRoomsQuery, G_GetRoomsQueryVariables>(
    GetRoomsDocument,
    options
  );
}
...
>;
export type GetRoomsSuspenseQueryHookResult = ReturnType<
  typeof useGetRoomsSuspenseQuery
>;
export type GetRoomsQueryResult = QueryResult<
  G_GetRoomsQuery,
  G_GetRoomsQueryVariables
>;
...
export function useGetRoomQuery(
  baseOptions: QueryHookOptions<G_GetRoomQuery, G_GetRoomQueryVariables> &
    ({ variables: G_GetRoomQueryVariables; skip?: boolean } | { skip: boolean })
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<G_GetRoomQuery, G_GetRoomQueryVariables>(
    GetRoomDocument,
    options
  );
}
export function useGetRoomLazyQuery(
  baseOptions?: LazyQueryHookOptions<G_GetRoomQuery, G_GetRoomQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<G_GetRoomQuery, G_GetRoomQueryVariables>(
    GetRoomDocument,
    options
  );
}
export function useGetRoomSuspenseQuery(
  baseOptions?:
    | SkipToken
    | SuspenseQueryHookOptions<G_GetRoomQuery, G_GetRoomQueryVariables>
) {
  const options =
    baseOptions === skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<G_GetRoomQuery, G_GetRoomQueryVariables>(
    GetRoomDocument,
    options
  );
}
...
export type GetRoomSuspenseQueryHookResult = ReturnType<
  typeof useGetRoomSuspenseQuery
>;
export type GetRoomQueryResult = QueryResult<
  G_GetRoomQuery,
  G_GetRoomQueryVariables
>;
...
export function useGetMessagesQuery(
  baseOptions: QueryHookOptions<
    G_GetMessagesQuery,
    G_GetMessagesQueryVariables
  > &
    (
      | { variables: G_GetMessagesQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<G_GetMessagesQuery, G_GetMessagesQueryVariables>(
    GetMessagesDocument,
    options
  );
}
export function useGetMessagesLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<G_GetMessagesQuery, G_GetMessagesQueryVariables>(
    GetMessagesDocument,
    options
  );
}
export function useGetMessagesSuspenseQuery(
  baseOptions?:
    | SkipToken
    | SuspenseQueryHookOptions<G_GetMessagesQuery, G_GetMessagesQueryVariables>
) {
  const options =
    baseOptions === skipToken
      ? baseOptions
...
`;
export type G_CreateOrGetRoomMutationFn = MutationFunction<
  G_CreateOrGetRoomMutation,
  G_CreateOrGetRoomMutationVariables
>;
 ...
 * });
 */
export function useCreateOrGetRoomMutation(
  ...
  return Apollo.useMutation<
    G_CreateOrGetRoomMutation,
    G_CreateOrGetRoomMutationVariables
  >(CreateOrGetRoomDocument, options);
}
export type CreateOrGetRoomMutationHookResult = ReturnType<
  typeof useCreateOrGetRoomMutation
>;
export type CreateOrGetRoomMutationResult =
  MutationResult<G_CreateOrGetRoomMutation>;
export type CreateOrGetRoomMutationOptions = BaseMutationOptions<
  G_CreateOrGetRoomMutation,
  G_CreateOrGetRoomMutationVariables
>;
...
`;
export type G_SendMessageMutationFn = MutationFunction<
  G_SendMessageMutation,
  G_SendMessageMutationVariables
>;
...
export type SendMessageMutationOptions = BaseMutationOptions<
  G_SendMessageMutation,
  G_SendMessageMutationVariables
>;
...
`;
export type G_CreateInternMutationFn = MutationFunction<
  G_CreateInternMutation,
  G_CreateInternMutationVariables
>;
 ...
 * });
 */
export function useCreateInternMutation(
  baseOptions?: MutationHookOptions<
    G_CreateInternMutation,
    G_CreateInternMutationVariables
  >
  ...
  return Apollo.useMutation<
    G_CreateInternMutation,
    G_CreateInternMutationVariables
  >(CreateInternDocument, options);
}
export type CreateInternMutationHookResult = ReturnType<
  typeof useCreateInternMutation
>;
export type CreateInternMutationResult = MutationResult<G_CreateInternMutation>;
export type CreateInternMutationOptions = BaseMutationOptions<
  G_CreateInternMutation,
  G_CreateInternMutationVariables
>;
